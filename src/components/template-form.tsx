...
import { createEmailTemplate, updateEmailTemplate } from '@/app/templates/actions';
...
export function TemplateForm({ template }: TemplateFormProps) {
  ...
  const [state, formAction] = useFormState(template ? updateEmailTemplate.bind(null, template.id) : createEmailTemplate, null);
    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
      <Card className="lg:col-span-2">
        <CardHeader>
          ...
          <CardDescription>
            Design your email template. Use the merge fields to personalize your emails.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="e.g., 'Trademark Renewal Notice'" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
      ...
      <div className="lg:col-span-1">
        <Card>
            <CardHeader>
                ...
                <CardDescription>Click to copy a merge field to your clipboard.</CardDescription>
            </CardHeader>
                    ...
                    <div key={group.group}>
                        ...
                        {group.fields.map(field => (
                            ...
                            >
                                ...
                                <span className="font-code text-xs text-muted-foreground">{field.value}</span>
                            </Button>
                        ))}
                        </div>
                    </div>
