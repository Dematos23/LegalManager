...
export const en = {
  ...
  dashboard: {
    ...
    expiring30: '0-30 days',
    expiring60: '31-60 days',
    expiring90: '61-90 days',
  ...
  import: {
    ...
    importTitle: '3. Validate & Import',
    importDescription: 'First, verify the file data for errors. After successful verification, you can import it.',
    verifyButton: 'Verify Data',
  ...
  tracking: {
    ...
    filtersTitle: 'Filters',
    searchPlaceholder: 'Search by campaign name or user...',
  ...
  trademarkForm: {
    ...
    editTitle: 'Edit Trademark',
    description: 'Fill in the details for the new trademark.',
    editDescription: 'Modify the necessary fields for the trademark.',
